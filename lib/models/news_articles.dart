...
class Source{
  ...
  // berfungsi untuk merapihkan format data yang dudapatkan dari server
  //yang awalnya bertipe data .json, menjadi data yang dimengerti oleh bahasa pemrograman dart
